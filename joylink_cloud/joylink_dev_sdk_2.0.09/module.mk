...
C_FILES  += 		 		$(JOYLINK_SRC)/auth/crc.c \
							...
							$(JOYLINK_SRC)/config/joylink_probe.c \
                                                        $(JOYLINK_SRC)/config/joylink_config_handle.c \
                                                        $(JOYLINK_SRC)/config/joylink_smart_config.c \
                                                        $(JOYLINK_SRC)/config/joylink_thunder_slave_sdk.c \
...
CFLAGS  += -I$(SOURCE_DIR)/$(JOYLINK_SRC)/config
